...
def test_get_date_from_key():
    ...
    assert PolygonS3Access._get_date_from_key(key) == "2023-03-15"
...
def test_key_is_within_given_years_recent():
    ...
    assert PolygonS3Access._key_is_within_given_years(key, 5)
...
def test_key_is_within_given_years_too_old():
    ...
    assert not PolygonS3Access._key_is_within_given_years(key, 5)
